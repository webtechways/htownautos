...
exports.VehicleConditionsController = void 0;
...
let VehicleConditionsController = class VehicleConditionsController {
    nomenclatorsService;
...
exports.VehicleConditionsController = VehicleConditionsController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'vehicle-condition', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new vehicle condition' }),
...
], VehicleConditionsController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'vehicle-condition', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all vehicle conditions' }),
    ...
    __metadata("design:returntype", Promise)
], VehicleConditionsController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'vehicle-condition', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get vehicle condition by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], VehicleConditionsController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'vehicle-condition', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a vehicle condition' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], VehicleConditionsController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'vehicle-condition', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a vehicle condition' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], VehicleConditionsController.prototype, "remove", null);
exports.VehicleConditionsController = VehicleConditionsController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Vehicle Conditions'),
    (0, common_1.Controller)('nom/vehicle-conditions'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], VehicleConditionsController);
//# sourceMappingURL=vehicle-conditions.controller.js.map