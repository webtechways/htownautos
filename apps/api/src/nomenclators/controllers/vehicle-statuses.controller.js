...
exports.VehicleStatusesController = void 0;
...
let VehicleStatusesController = class VehicleStatusesController {
    nomenclatorsService;
...
exports.VehicleStatusesController = VehicleStatusesController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'vehicle-status', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new vehicle statuse' }),
...
], VehicleStatusesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'vehicle-status', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all vehicle statuses' }),
    ...
    __metadata("design:returntype", Promise)
], VehicleStatusesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'vehicle-status', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get vehicle statuse by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], VehicleStatusesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'vehicle-status', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a vehicle statuse' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], VehicleStatusesController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'vehicle-status', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a vehicle statuse' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], VehicleStatusesController.prototype, "remove", null);
exports.VehicleStatusesController = VehicleStatusesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Vehicle Statuses'),
    (0, common_1.Controller)('nom/vehicle-statuses'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], VehicleStatusesController);
//# sourceMappingURL=vehicle-statuses.controller.js.map