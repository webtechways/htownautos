...
exports.MileageUnitsController = void 0;
...
let MileageUnitsController = class MileageUnitsController {
    nomenclatorsService;
...
exports.MileageUnitsController = MileageUnitsController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'mileage-unit', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new mileage unit' }),
...
], MileageUnitsController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'mileage-unit', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all mileage units' }),
    ...
    __metadata("design:returntype", Promise)
], MileageUnitsController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'mileage-unit', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get mileage unit by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], MileageUnitsController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'mileage-unit', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a mileage unit' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], MileageUnitsController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'mileage-unit', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a mileage unit' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], MileageUnitsController.prototype, "remove", null);
exports.MileageUnitsController = MileageUnitsController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Mileage Units'),
    (0, common_1.Controller)('nom/mileage-units'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], MileageUnitsController);
//# sourceMappingURL=mileage-units.controller.js.map