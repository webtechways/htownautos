...
exports.ContactTimesController = void 0;
...
let ContactTimesController = class ContactTimesController {
    nomenclatorsService;
...
exports.ContactTimesController = ContactTimesController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'contact-time', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new contact time' }),
...
], ContactTimesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'contact-time', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all contact times' }),
    ...
    __metadata("design:returntype", Promise)
], ContactTimesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'contact-time', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get contact time by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ContactTimesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'contact-time', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a contact time' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], ContactTimesController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'contact-time', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a contact time' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ContactTimesController.prototype, "remove", null);
exports.ContactTimesController = ContactTimesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Contact Times'),
    (0, common_1.Controller)('nom/contact-times'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], ContactTimesController);
//# sourceMappingURL=contact-times.controller.js.map