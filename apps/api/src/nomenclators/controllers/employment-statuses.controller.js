...
exports.EmploymentStatusesController = void 0;
...
let EmploymentStatusesController = class EmploymentStatusesController {
    nomenclatorsService;
...
exports.EmploymentStatusesController = EmploymentStatusesController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'employment-status', level: 'medium', pii: true }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new employment statuse' }),
...
], EmploymentStatusesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'employment-status', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all employment statuses' }),
    ...
    __metadata("design:returntype", Promise)
], EmploymentStatusesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'employment-status', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get employment statuse by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], EmploymentStatusesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'employment-status', level: 'medium', pii: true }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a employment statuse' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], EmploymentStatusesController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'employment-status', level: 'high', pii: true }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a employment statuse' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], EmploymentStatusesController.prototype, "remove", null);
exports.EmploymentStatusesController = EmploymentStatusesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Employment Statuses'),
    (0, common_1.Controller)('nom/employment-statuses'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], EmploymentStatusesController);
//# sourceMappingURL=employment-statuses.controller.js.map