...
exports.DriveTypesController = void 0;
...
let DriveTypesController = class DriveTypesController {
    nomenclatorsService;
...
exports.DriveTypesController = DriveTypesController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'drive-type', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new drive type' }),
...
], DriveTypesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'drive-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all drive types' }),
    ...
    __metadata("design:returntype", Promise)
], DriveTypesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'drive-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get drive type by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], DriveTypesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'drive-type', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a drive type' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], DriveTypesController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'drive-type', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a drive type' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], DriveTypesController.prototype, "remove", null);
exports.DriveTypesController = DriveTypesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Drive Types'),
    (0, common_1.Controller)('nom/drive-types'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], DriveTypesController);
//# sourceMappingURL=drive-types.controller.js.map