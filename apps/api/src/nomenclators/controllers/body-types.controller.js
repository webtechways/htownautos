...
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'body-type', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new body type' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'body-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all body types' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'body-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get body type by ID' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'body-type', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a body type' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, common_3.AuditLog)({ action: 'delete', resource: 'body-type', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a body type' }),
...
exports.BodyTypesController = BodyTypesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Body Types'),
    (0, common_1.Controller)('nom/body-types'),
