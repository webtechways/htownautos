...
exports.ContactMethodsController = void 0;
...
let ContactMethodsController = class ContactMethodsController {
    nomenclatorsService;
...
exports.ContactMethodsController = ContactMethodsController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'contact-method', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new contact method' }),
...
], ContactMethodsController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'contact-method', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all contact methods' }),
    ...
    __metadata("design:returntype", Promise)
], ContactMethodsController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'contact-method', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get contact method by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ContactMethodsController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'contact-method', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a contact method' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], ContactMethodsController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'contact-method', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a contact method' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ContactMethodsController.prototype, "remove", null);
exports.ContactMethodsController = ContactMethodsController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Contact Methods'),
    (0, common_1.Controller)('nom/contact-methods'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], ContactMethodsController);
//# sourceMappingURL=contact-methods.controller.js.map