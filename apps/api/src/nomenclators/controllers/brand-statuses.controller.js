...
exports.BrandStatusesController = void 0;
...
let BrandStatusesController = class BrandStatusesController {
    nomenclatorsService;
...
exports.BrandStatusesController = BrandStatusesController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'brand-status', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new brand statuse' }),
...
], BrandStatusesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'brand-status', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all brand statuses' }),
    ...
    __metadata("design:returntype", Promise)
], BrandStatusesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'brand-status', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get brand statuse by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], BrandStatusesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'brand-status', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a brand statuse' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], BrandStatusesController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'brand-status', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a brand statuse' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], BrandStatusesController.prototype, "remove", null);
exports.BrandStatusesController = BrandStatusesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Brand Statuses'),
    (0, common_1.Controller)('nom/brand-statuses'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], BrandStatusesController);
//# sourceMappingURL=brand-statuses.controller.js.map