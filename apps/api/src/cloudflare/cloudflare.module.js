...
const cloudflare_dns_service_1 = require("./cloudflare-dns.service");
...
exports.CloudflareModule = CloudflareModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [cloudflare_dns_service_1.CloudflareDnsService],
        exports: [cloudflare_dns_service_1.CloudflareDnsService],
    })
], CloudflareModule);
