...
exports.VehicleSourcesController = void 0;
...
let VehicleSourcesController = class VehicleSourcesController {
    nomenclatorsService;
...
exports.VehicleSourcesController = VehicleSourcesController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'vehicle-source', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new vehicle source' }),
...
], VehicleSourcesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'vehicle-source', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all vehicle sources' }),
    ...
    __metadata("design:returntype", Promise)
], VehicleSourcesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'vehicle-source', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get vehicle source by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], VehicleSourcesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'vehicle-source', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a vehicle source' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], VehicleSourcesController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'vehicle-source', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a vehicle source' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], VehicleSourcesController.prototype, "remove", null);
exports.VehicleSourcesController = VehicleSourcesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Vehicle Sources'),
    (0, common_1.Controller)('nom/vehicle-sources'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], VehicleSourcesController);
//# sourceMappingURL=vehicle-sources.controller.js.map