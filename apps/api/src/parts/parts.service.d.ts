...
export declare class PartsService {
    ...
    updateQuantity(tenantId: string, id: string, adjustment: number, reason?: string): Promise<{
        model: {
            name: string;
            id: string;
            slug: string;
    ...
    markAsSold(tenantId: string, id: string, soldData: {
        soldToId?: string;
        soldPrice?: number;
        soldDealId?: string;
    }): Promise<{
    ...
    getLowStockParts(tenantId: string): Promise<any>;
    backfillMissingSKUs(tenantId: string): Promise<{
        updated: number;
    }>;
    private getPartIncludes;
    createCondition(tenantId: string | null, dto: CreatePartConditionDto): Promise<{
        id: string;
        slug: string;
        title: string;
        isActive: boolean;
    ...
    createStatus(tenantId: string | null, dto: CreatePartStatusDto): Promise<{
        id: string;
        slug: string;
        title: string;
        isActive: boolean;
    ...
    createCategory(tenantId: string | null, dto: CreatePartCategoryDto): Promise<{
        parent: {
            id: string;
            slug: string;
            title: string;
    ...
    findAllCategories(tenantId: string, includeChildren?: boolean): Promise<{
        id: string;
        slug: string;
        title: string;
        isActive: boolean;
