...
let ActivityTypesController = class ActivityTypesController {
    ...
    async create(createDto) {
        return this.nomenclatorsService.create('activity-types', createDto);
    }
    async findAll(query) {
        return this.nomenclatorsService.findAll('activity-types', query);
    }
    async findOne(id) {
        return this.nomenclatorsService.findOne('activity-types', id);
    }
    async update(id, updateDto) {
        return this.nomenclatorsService.update('activity-types', id, updateDto);
    }
    async remove(id) {
        return this.nomenclatorsService.remove('activity-types', id);
    }
};
exports.ActivityTypesController = ActivityTypesController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'activity-type', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new activity type' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'activity-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all activity types' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'activity-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get activity type by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], ActivityTypesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'activity-type', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a activity type' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, common_3.AuditLog)({ action: 'delete', resource: 'activity-type', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a activity type' }),
...
exports.ActivityTypesController = ActivityTypesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Activity Types'),
    (0, common_1.Controller)('nom/activity-types'),
