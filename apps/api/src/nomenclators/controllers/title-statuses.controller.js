...
exports.TitleStatusesController = void 0;
...
let TitleStatusesController = class TitleStatusesController {
    nomenclatorsService;
...
exports.TitleStatusesController = TitleStatusesController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'title-status', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new title statuse' }),
...
], TitleStatusesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'title-status', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all title statuses' }),
    ...
    __metadata("design:returntype", Promise)
], TitleStatusesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'title-status', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get title statuse by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], TitleStatusesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'title-status', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a title statuse' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], TitleStatusesController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'title-status', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a title statuse' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], TitleStatusesController.prototype, "remove", null);
exports.TitleStatusesController = TitleStatusesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Title Statuses'),
    (0, common_1.Controller)('nom/title-statuses'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], TitleStatusesController);
//# sourceMappingURL=title-statuses.controller.js.map