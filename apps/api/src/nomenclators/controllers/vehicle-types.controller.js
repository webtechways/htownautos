...
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'vehicle-type', level: 'medium', pii: false }),
...
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'vehicle-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all vehicle types' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'vehicle-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get vehicle type by ID' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'vehicle-type', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a vehicle type' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, common_3.AuditLog)({ action: 'delete', resource: 'vehicle-type', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a vehicle type' }),
...
exports.VehicleTypesController = VehicleTypesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Vehicle Types'),
    (0, common_1.Controller)('nom/vehicle-types'),
