...
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'fuel-type', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new fuel type' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'fuel-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all fuel types' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'fuel-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get fuel type by ID' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'fuel-type', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a fuel type' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, common_3.AuditLog)({ action: 'delete', resource: 'fuel-type', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a fuel type' }),
...
exports.FuelTypesController = FuelTypesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Fuel Types'),
    (0, common_1.Controller)('nom/fuel-types'),
