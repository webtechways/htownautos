...
exports.VehicleEnginesController = void 0;
...
let VehicleEnginesController = class VehicleEnginesController {
    nomenclatorsService;
...
exports.VehicleEnginesController = VehicleEnginesController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'vehicle-engine', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new vehicle engine' }),
...
], VehicleEnginesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'vehicle-engine', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all vehicle engines' }),
    ...
    __metadata("design:returntype", Promise)
], VehicleEnginesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'vehicle-engine', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get vehicle engine by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], VehicleEnginesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'vehicle-engine', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a vehicle engine' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], VehicleEnginesController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'vehicle-engine', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a vehicle engine' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], VehicleEnginesController.prototype, "remove", null);
exports.VehicleEnginesController = VehicleEnginesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Vehicle Engines'),
    (0, common_1.Controller)('nom/vehicle-engines'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], VehicleEnginesController);
//# sourceMappingURL=vehicle-engines.controller.js.map