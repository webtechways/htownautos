...
exports.IdTypesController = void 0;
...
let IdTypesController = class IdTypesController {
    nomenclatorsService;
...
exports.IdTypesController = IdTypesController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'id-type', level: 'medium', pii: true }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new id type' }),
...
], IdTypesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'id-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all id types' }),
    ...
    __metadata("design:returntype", Promise)
], IdTypesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'id-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get id type by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], IdTypesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'id-type', level: 'medium', pii: true }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a id type' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], IdTypesController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'id-type', level: 'high', pii: true }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a id type' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], IdTypesController.prototype, "remove", null);
exports.IdTypesController = IdTypesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - ID Types'),
    (0, common_1.Controller)('nom/id-types'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], IdTypesController);
//# sourceMappingURL=id-types.controller.js.map