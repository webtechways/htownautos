...
exports.InspectionStatusesController = void 0;
...
let InspectionStatusesController = class InspectionStatusesController {
    nomenclatorsService;
...
exports.InspectionStatusesController = InspectionStatusesController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'inspection-status', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new inspection statuse' }),
...
], InspectionStatusesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'inspection-status', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all inspection statuses' }),
    ...
    __metadata("design:returntype", Promise)
], InspectionStatusesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'inspection-status', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get inspection statuse by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], InspectionStatusesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'inspection-status', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a inspection statuse' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], InspectionStatusesController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'inspection-status', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a inspection statuse' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], InspectionStatusesController.prototype, "remove", null);
exports.InspectionStatusesController = InspectionStatusesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Inspection Statuses'),
    (0, common_1.Controller)('nom/inspection-statuses'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], InspectionStatusesController);
//# sourceMappingURL=inspection-statuses.controller.js.map