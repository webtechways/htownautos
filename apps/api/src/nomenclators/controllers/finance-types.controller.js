...
exports.FinanceTypesController = void 0;
...
let FinanceTypesController = class FinanceTypesController {
    nomenclatorsService;
...
exports.FinanceTypesController = FinanceTypesController;
__decorate([
    (0, common_1.Post)(),
    (0, common_3.AuditLog)({ action: 'create', resource: 'finance-type', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new finance type' }),
...
], FinanceTypesController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_3.AuditLog)({ action: 'read', resource: 'finance-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get all finance types' }),
    ...
    __metadata("design:returntype", Promise)
], FinanceTypesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_3.AuditLog)({ action: 'read', resource: 'finance-type', level: 'low', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Get finance type by ID' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], FinanceTypesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, common_3.AuditLog)({ action: 'update', resource: 'finance-type', level: 'medium', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Update a finance type' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, type: nomenclator_entity_1.NomenclatorEntity }),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], FinanceTypesController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_3.AuditLog)({ action: 'delete', resource: 'finance-type', level: 'high', pii: false }),
    (0, swagger_1.ApiOperation)({ summary: 'Delete a finance type' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], FinanceTypesController.prototype, "remove", null);
exports.FinanceTypesController = FinanceTypesController = __decorate([
    (0, swagger_1.ApiTags)('Nomenclators - Finance Types'),
    (0, common_1.Controller)('nom/finance-types'),
    __metadata("design:paramtypes", [nomenclators_service_1.NomenclatorsService])
], FinanceTypesController);
//# sourceMappingURL=finance-types.controller.js.map